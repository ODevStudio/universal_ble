...
enum PeripheralAttributePermission: Int {
  case readable = 0
  case writeable = 1
...
struct ManufacturerDataFilter: Hashable {
  ...
  static func == (lhs: ManufacturerDataFilter, rhs: ManufacturerDataFilter) -> Bool {
    ...
    return deepEqualsUniversalBle(lhs.companyIdentifier, rhs.companyIdentifier) && deepEqualsUniversalBle(lhs.payloadPrefix, rhs.payloadPrefix) && deepEqualsUniversalBle(lhs.payloadMask, rhs.payloadMask)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("ManufacturerDataFilter")
    deepHashUniversalBle(value: companyIdentifier, hasher: &hasher)
    deepHashUniversalBle(value: payloadPrefix, hasher: &hasher)
    deepHashUniversalBle(value: payloadMask, hasher: &hasher)
  }
}
...
struct PeripheralCharacteristic: Hashable {
  var uuid: String
  var properties: [CharacteristicProperty]
  var permissions: [PeripheralAttributePermission]
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PeripheralCharacteristic? {
    let uuid = pigeonVar_list[0] as! String
    let properties = pigeonVar_list[1] as! [CharacteristicProperty]
    let permissions = pigeonVar_list[2] as! [PeripheralAttributePermission]
...
struct PeripheralDescriptor: Hashable {
  var uuid: String
  var value: FlutterStandardTypedData? = nil
  var permissions: [PeripheralAttributePermission]? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PeripheralDescriptor? {
    ...
    let permissions: [PeripheralAttributePermission]? = nilOrValue(pigeonVar_list[2])
