...
enum class UniversalBleErrorCode(val raw: Int) {
  ...
  CHARACTERISTIC_DOES_NOT_SUPPORT_WRITE(39),
  CHARACTERISTIC_DOES_NOT_SUPPORT_WRITE_WITHOUT_RESPONSE(40),
  CHARACTERISTIC_DOES_NOT_SUPPORT_NOTIFY(41),
  CHARACTERISTIC_DOES_NOT_SUPPORT_INDICATE(42),
  NOT_PAIRED(43),
  NOT_PAIRABLE(44),
  ALREADY_PAIRED(45),
  PAIRING_FAILED(46),
  PAIRING_CANCELLED(47),
  PAIRING_TIMEOUT(48),
  PAIRING_NOT_ALLOWED(49),
  AUTHENTICATION_FAILURE(50),
  INSUFFICIENT_AUTHENTICATION(51),
  INSUFFICIENT_AUTHORIZATION(52),
  INSUFFICIENT_ENCRYPTION(53),
  INSUFFICIENT_KEY_SIZE(54),
  PROTECTION_LEVEL_NOT_MET(55),
  ACCESS_DENIED(56),
  UNPAIRING_FAILED(57),
  ALREADY_UNPAIRED(58),
  SCAN_FAILED(59),
