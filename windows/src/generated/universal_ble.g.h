...
enum class UniversalBleErrorCode {
  ...
  kCharacteristicDoesNotSupportWriteWithoutResponse = 40,
  kCharacteristicDoesNotSupportNotify = 41,
  kCharacteristicDoesNotSupportIndicate = 42,
  kNotPaired = 43,
  kNotPairable = 44,
  kAlreadyPaired = 45,
  kPairingFailed = 46,
  kPairingCancelled = 47,
  kPairingTimeout = 48,
  kPairingNotAllowed = 49,
  kAuthenticationFailure = 50,
  kInsufficientAuthentication = 51,
  kInsufficientAuthorization = 52,
  kInsufficientEncryption = 53,
  kInsufficientKeySize = 54,
  kProtectionLevelNotMet = 55,
  kAccessDenied = 56,
  kUnpairingFailed = 57,
  kAlreadyUnpaired = 58,
  kScanFailed = 59,
